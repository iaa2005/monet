/**
 * STUB for '@opentelemetry/exporter-metrics-otlp-proto' — package is Anthropic-internal, cloud-provider or
...
const stubFn: any = new Proxy(function stubbed() {}, {
  ...
  apply: () => undefined,
  construct: () => { throw new Error('stubbed package: @opentelemetry/exporter-metrics-otlp-proto') },
})
