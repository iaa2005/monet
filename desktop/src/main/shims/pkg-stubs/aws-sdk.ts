/**
 * STUB for '@aws-sdk/' — package is Anthropic-internal, cloud-provider or
...
const stubFn: any = new Proxy(function stubbed() {}, {
  ...
  apply: () => undefined,
  construct: () => { throw new Error('stubbed package: @aws-sdk/') },
})

export const CountTokensCommandInput: any = stubFn
