/**
 * STUB for '@opentelemetry/exporter-logs-otlp-grpc' — package is Anthropic-internal, cloud-provider or
...
const stubFn: any = new Proxy(function stubbed() {}, {
  ...
  apply: () => undefined,
  construct: () => { throw new Error('stubbed package: @opentelemetry/exporter-logs-otlp-grpc') },
})
