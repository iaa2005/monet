/**
 * STUB for 'google-auth-library' — package is Anthropic-internal, cloud-provider or
...
const stubFn: any = new Proxy(function stubbed() {}, {
  ...
  apply: () => undefined,
  construct: () => { throw new Error('stubbed package: google-auth-library') },
})

export const GoogleAuth: any = stubFn
