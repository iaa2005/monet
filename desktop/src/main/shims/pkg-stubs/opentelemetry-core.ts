/**
 * STUB for '@opentelemetry/core' — package is Anthropic-internal, cloud-provider or
...
const stubFn: any = new Proxy(function stubbed() {}, {
  ...
  apply: () => undefined,
  construct: () => { throw new Error('stubbed package: @opentelemetry/core') },
})

export const ExportResult: any = stubFn
export type ExportResult = any
export const ExportResultCode: any = stubFn
