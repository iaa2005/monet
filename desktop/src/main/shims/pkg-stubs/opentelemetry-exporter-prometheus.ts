/**
 * STUB for '@opentelemetry/exporter-prometheus' — package is Anthropic-internal, cloud-provider or
...
const stubFn: any = new Proxy(function stubbed() {}, {
  ...
  apply: () => undefined,
  construct: () => { throw new Error('stubbed package: @opentelemetry/exporter-prometheus') },
})
