...
function voiceDirectiveFor(
  ...
  return tunablePrompt(
    ...
    [
      ...
      "performed, never sees them. Never OPEN a paragraph or reply with a",
      "tag — start with words, tags work from the second sentence on.",
      "Never place a tag mid-sentence — it is",
