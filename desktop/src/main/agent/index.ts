...
const CHART_WIDGET_DEFAULT = [
  "To DRAW a chart, write a fenced block whose language is chart. The fence",
  "is what makes it a chart: three backticks, the word chart, the JSON, three",
  "backticks. Without it you have written JSON at the reader, which is worse",
  "than a table.",
  "",
  '```chart',
  ...
  '```',
  "",
  "type is line, area, bar or candlestick. A single series may sit at the top",
  "level like that; for several, use series: [{ name, data }, ...] and each",
  "gets its own colour.",
  "",
  ...
  "gaps, which is most of what a price chart is read for. A line is right for",
  "a single measured quantity over time — a metric, a count, a temperature.",
  "",
  ...
  '```',
  "",
  "title is the ticker and name is the company — write both; a symbol is an",
  "abbreviation and the chart should not make the reader expand it. The file",
  "holds the rows (labels/ohlc/data/volume); the block says what kind of",
