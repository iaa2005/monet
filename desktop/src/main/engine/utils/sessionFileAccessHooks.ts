...
import { registerHookCallbacks } from '../state/state.js'
import type { HookInput, HookJSONOutput } from '../types/agentSdkTypes.js'
import {
...
const teamMemWatcher = feature('TEAMMEM')
  ? (require('../swarm/watcher.js') as typeof import('../swarm/watcher.js'))
  : null
const memoryShapeTelemetry = feature('MEMORY_SHAPE_TELEMETRY')
  ? (require('../../memory/dir/memoryShapeTelemetry.js') as typeof import('../../memory/dir/memoryShapeTelemetry.js'))
  : null
