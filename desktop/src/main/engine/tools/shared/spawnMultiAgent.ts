...
import { quote } from '../../shell/bash/shellQuote.js'
...
import { getTeammateModeFromSnapshot } from '../../swarm/backends/teammateModeSnapshot.js'
...
import { It2SetupPrompt } from '../../swarm/It2SetupPrompt.jsx'
import { startInProcessTeammate } from '../../swarm/inProcessRunner.js'
import {
  type InProcessSpawnConfig,
  spawnInProcessTeammate,
} from '../../swarm/spawnInProcess.js'
...
import {
  ...
  isInsideTmux,
  sendCommandToPane,
} from '../../swarm/teammateLayoutManager.js'
import { getHardcodedTeammateModelFallback } from '../../swarm/teammateModel.js'
import { registerTask } from '../../tasks/framework.js'
