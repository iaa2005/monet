...
import { getUseCoworkPlugins } from '../engine/state/state.js'
import { logForDebugging } from '../engine/utils/debug.js'
import { getClaudeConfigHomeDir, isEnvTruthy } from '../engine/utils/envUtils.js'
import { errorMessage, isFsInaccessible } from '../engine/utils/errors.js'
import { formatFileSize } from '../engine/utils/format.js'
import { expandTilde } from '../engine/permissions/pathValidation.js'
