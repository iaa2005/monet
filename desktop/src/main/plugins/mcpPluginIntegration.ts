...
import { expandEnvVarsInString } from '../mcp/protocol/envExpansion.js'
import {
  type McpServerConfig,
  McpServerConfigSchema,
  type ScopedMcpServerConfig,
} from '../mcp/protocol/types.js'
import type { LoadedPlugin, PluginError } from '../engine/types/plugin.js'
import { logForDebugging } from '../engine/utils/debug.js'
import { errorMessage, isENOENT } from '../engine/utils/errors.js'
