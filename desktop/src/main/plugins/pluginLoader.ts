...
import { getInlinePlugins } from '../engine/state/state.js'
import {
  BUILTIN_MARKETPLACE_NAME,
  getBuiltinPlugins,
} from './builtin/builtinPlugins.js'
import type {
  LoadedPlugin,
  PluginComponent,
  PluginError,
...
import { execFileNoThrow, execFileNoThrowWithCwd } from '../engine/utils/execFileNoThrow.js'
import { pathExists } from '../engine/utils/file.js'
import { getFsImplementation } from '../engine/utils/fsOperations.js'
import { gitExe } from '../engine/utils/git.js'
