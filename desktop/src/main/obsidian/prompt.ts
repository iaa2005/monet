...
const RULES_DEFAULT = [
  ...
  "  user wants kept goes in with VaultAttach — it copies into the vault's",
  ...
  "- CHANGE A NOTE IN PLACE with VaultEdit (exact old_string → new_string),",
  "  not by rewriting the whole file with VaultWrite. VaultWrite replaces",
  "  everything and is for a NEW note or a deliberate full rewrite.",
  "- MOVE OR RENAME with VaultMove — it also rewrites the [[links]] that",
