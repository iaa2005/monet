...
import { getOriginalCwd, getSessionId } from '../../engine/state/state.js'
import type { Command } from '../../engine/types/command.js'
import { getOauthConfig } from '../../engine/constants/oauth.js'
import { PRODUCT_URL } from '../../engine/constants/product.js'
import type { AppState } from '../../engine/state/AppState.jsx'
import {
  type Tool,
...
import { type MCPProgress, MCPTool } from '../../engine/tools/MCPTool/MCPTool.js'
import { createMcpAuthTool } from '../../engine/tools/McpAuthTool/McpAuthTool.js'
...
import { count } from '../../engine/utils/array.js'
import {
...
import { isEnvDefinedFalsy, isEnvTruthy } from '../../engine/utils/envUtils.js'
import {
  errorMessage,
...
} from '../../engine/utils/mcpOutputStorage.js'
import {
  getContentSizeEstimate,
  type MCPToolResult,
  mcpContentNeedsTruncation,
  truncateMcpContentIfNeeded,
} from '../../engine/utils/mcpValidation.js'
import { WebSocketTransport } from '../../engine/utils/mcpWebSocketTransport.js'
import { memoizeWithLRU } from '../../engine/utils/memoize.js'
import { getWebSocketTLSOptions } from '../../engine/utils/mtls.js'
import {
  getProxyFetchOptions,
  getWebSocketProxyAgent,
  getWebSocketProxyUrl,
} from '../../engine/utils/proxy.js'
import { recursivelySanitizeUnicode } from '../../engine/utils/sanitization.js'
import { getSessionIngressAuthToken } from '../../engine/utils/sessionIngressAuth.js'
import { subprocessEnv } from '../../engine/utils/subprocessEnv.js'
import {
  isPersistError,
  persistToolResult,
} from '../../engine/utils/toolResultStorage.js'
import {
...
const fetchMcpSkillsForClient = feature('MCP_SKILLS')
  ? (
      require('../../skills/loader/mcpSkills.js') as typeof import('../../skills/loader/mcpSkills.js')
...
import { classifyMcpToolForCollapse } from '../../engine/tools/MCPTool/classifyForCollapse.js'
...
const computerUseWrapper = feature('CHICAGO_MCP')
  ? (): typeof import('../../computer/native/wrapper.jsx') =>
      require('../../computer/native/wrapper.jsx')
  : undefined
const isComputerUseMCPServer = feature('CHICAGO_MCP')
  ? (
      require('../../computer/native/common.js') as typeof import('../../computer/native/common.js')
...
/* eslint-enable @typescript-eslint/no-require-imports */
import { jsonParse, jsonStringify } from '../../engine/utils/slowOperations.js'
