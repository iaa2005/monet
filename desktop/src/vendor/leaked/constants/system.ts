...
const DEFAULT_PREFIX = `You are Code Monet, IAA Labs' desktop AI coding agent.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Code Monet, IAA Labs' desktop AI coding agent, running within the Code Monet Agent SDK.`
const AGENT_SDK_PREFIX = `You are a Code Monet agent, built on IAA Labs' Code Monet Agent SDK.`
