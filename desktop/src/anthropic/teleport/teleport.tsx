...
import { getOriginalCwd, getSessionId } from '@vendor/bootstrap/state.js';
...
import { AppStateProvider } from '@vendor/state/AppState.jsx';
import type { Message, SystemMessage } from '@vendor/types/message.js';
...
import { checkGithubAppInstalled } from '@vendor/utils/background/remote/preconditions.js';
import { deserializeMessages, type TeleportRemoteResponse } from '@vendor/utils/conversationRecovery.js';
import { getCwd } from '@vendor/utils/cwd.js';
import { logForDebugging } from '@vendor/utils/debug.js';
import { detectCurrentRepositoryWithHost, parseGitHubRepository, parseGitRemote } from '@vendor/utils/detectRepository.js';
import { isEnvTruthy } from '@vendor/utils/envUtils.js';
import { TeleportOperationError, toError } from '@vendor/utils/errors.js';
import { execFileNoThrow } from '@vendor/utils/execFileNoThrow.js';
import { truncateToWidth } from '@vendor/utils/format.js';
import { findGitRoot, getDefaultBranch, getIsClean, gitExe } from '@vendor/utils/git.js';
import { safeParseJSON } from '@vendor/utils/json.js';
import { logError } from '@vendor/utils/log.js';
import { createSystemMessage, createUserMessage } from '@vendor/utils/messages.js';
import { getMainLoopModel } from '@vendor/utils/model/model.js';
import { isTranscriptMessage } from '@vendor/utils/sessionStorage.js';
import { getSettings_DEPRECATED } from '@vendor/utils/settings/settings.js';
import { jsonStringify } from '@vendor/utils/slowOperations.js';
import { asSystemPrompt } from '@vendor/utils/systemPromptType.js';
