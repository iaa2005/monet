...
import { getOriginalCwd, getSessionId } from '@main/engine/state/state.js';
import { checkGate_CACHED_OR_BLOCKING } from '@main/engine/gates.js';
import { type AnalyticsMetadata_I_VERIFIED_THIS_IS_NOT_CODE_OR_FILEPATHS, logEvent } from '@main/engine/analytics.js';
import { isPolicyAllowed } from '../account/policy-limits/index.js';
import { z } from 'zod/v4';
import { getTeleportErrors, TeleportError, type TeleportLocalErrorType } from '@main/engine/stubs/cli/components/TeleportError.js';
import { getOauthConfig } from '@main/engine/constants/oauth.js';
import type { SDKMessage } from '../cli/entrypoints/agentSdkTypes.js';
import type { Root } from '@main/engine/stubs/cli/ink.js';
import { KeybindingSetup } from '@main/engine/stubs/cli/keybindings/KeybindingProviderSetup.js';
...
import { AppStateProvider } from '@main/engine/state/AppState.jsx';
import type { Message, SystemMessage } from '@main/engine/types/message.js';
import type { PermissionMode } from '@main/engine/types/permissions.js';
import { checkAndRefreshOAuthTokenIfNeeded, getClaudeAIOAuthTokens } from '../account/auth.js';
import { checkGithubAppInstalled } from '@main/engine/utils/background/remote/preconditions.js';
import { deserializeMessages, type TeleportRemoteResponse } from '@main/engine/utils/conversationRecovery.js';
import { getCwd } from '@main/engine/utils/cwd.js';
import { logForDebugging } from '@main/engine/utils/debug.js';
import { detectCurrentRepositoryWithHost, parseGitHubRepository, parseGitRemote } from '@main/engine/utils/detectRepository.js';
import { isEnvTruthy } from '@main/engine/utils/envUtils.js';
import { TeleportOperationError, toError } from '@main/engine/utils/errors.js';
import { execFileNoThrow } from '@main/engine/utils/execFileNoThrow.js';
import { truncateToWidth } from '@main/engine/utils/format.js';
import { findGitRoot, getDefaultBranch, getIsClean, gitExe } from '@main/engine/utils/git.js';
import { safeParseJSON } from '@main/engine/utils/json.js';
import { logError } from '@main/engine/utils/log.js';
import { createSystemMessage, createUserMessage } from '@main/engine/utils/messages.js';
import { getMainLoopModel } from '@main/llm/model/model.js';
import { isTranscriptMessage } from '@main/engine/utils/sessionStorage.js';
import { getSettings_DEPRECATED } from '@main/settings/settings.js';
import { jsonStringify } from '@main/engine/utils/slowOperations.js';
import { asSystemPrompt } from '@main/engine/utils/systemPromptType.js';
import { fetchSession, type GitRepositoryOutcome, type GitSource, getBranchFromSession, getOAuthHeaders, type SessionResource } from './api.js';
