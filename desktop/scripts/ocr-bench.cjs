...
const CANDIDATES = [
  ...
  },
  {
    ...
    device: "webgpu",
    prompt: "Convert this page to markdown.",
    note: "A different family from the default — fails differently, which is the point.",
  },
  {
    id: "qwen3vl-q4-gpu",
    label: "Qwen3-VL 2B q4 · GPU",
    engine: "transformers",
    ...
    note: "General-purpose, twice the size, far more Russian in its training.",
  },
  {
    id: "lighton-q4-cpu",
