...
const entry = resolve(out, "rg-entry.ts");
writeFileSync(
  entry,
  `export { ripGrep } from "../src/main/agent/ripgrep.js";
export { getWorkspacePath } from "../src/main/ipc/workspace.js";
`,
  "utf-8",
);
