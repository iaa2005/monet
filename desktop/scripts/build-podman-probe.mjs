...
const entry = resolve(out, "podman-entry.ts");
writeFileSync(
  entry,
  `export { runPodman, isPodmanReady, podmanInfoOk } from "../src/main/sandbox/podman-engine.js";
export { addPodmanToPath, ensurePodmanBinary } from "../src/main/sandbox/podman-binary.js";
`,
  "utf-8",
);
...
await build({
  ...
  outfile: resolve(out, "podman.mjs"),
  bundle: true,
  platform: "node",
  format: "esm",
