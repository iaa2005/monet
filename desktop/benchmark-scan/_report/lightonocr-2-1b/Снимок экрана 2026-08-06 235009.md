...
<table>
  <tr>
    <td>1</td>
    <td>import { AIAgent } from "@aigne/core";</td>
  </tr>
  <tr>
    <td>2</td>
    <td>import { AFS } from "@aigne/afs";</td>
  </tr>
  <tr>
    <td>3</td>
    <td>import { MCPAgent } from "@aigne/core";</td>
  </tr>
  <tr>
    <td>4</td>
    <td></td>
  ...
  <tr>
    <td>5</td>
    <td>const mcpAgent = await MCPAgent.from({ // create</td>
  </tr>
  <tr>
    <td>6</td>
    <td>agent from GitHub official MCP Server</td>
  </tr>
  <tr>
    <td>7</td>
    <td>command: "docker",</td>
  </tr>
  <tr>
    <td>8</td>
    <td>args: [</td>
  ...
  <tr>
    <td>10</td>
    <td>"-e", `GITHUB_PERSONAL_ACCESS_TOKEN=${process</td>
  </tr>
  <tr>
    <td>11</td>
    <td>env.GITHUB_PERSONAL_ACCESS_TOKEN}`,</td>
  </tr>
  <tr>
    <td>12</td>
    <td>"ghcr.io/github/github-mcp",</td>
  </tr>
  <tr>
    <td>13</td>
    <td>],</td>
  ...
  <tr>
    <td>14</td>
    <td>const afs = new AFS()</td>
  </tr>
  <tr>
    <td>15</td>
    <td>.mount(mcpAgent); //Mounted at /modules/github-</td>
  </tr>
  <tr>
    <td>16</td>
    <td>mcp</td>
  ...
  <tr>
    <td>17</td>
    <td>const agent = AIAgent.from({</td>
  </tr>
  <tr>
    <td>18</td>
    <td>instructions: "Help users interact with GitHub</td>
  </tr